...
GHOST AI is a real-time collaborative system design workspace. Users descripe the design in plain English, then the AI agents map the system on the shared canvas. Then, allow collaborators refine the architecture. And, the app can generate a technical specification file from the resulting graph.

## Goals

1. Let authenticated users create and manage architecture projects
2. Provide real-time collaborative canvas for system design
...
5. Let collaborators refine the final architecture
6. Export a technical specification Markdown file from the final graph.
...
10. User reviews or download the spec.
...
- Live cursors, presence indicator, and node/edge editing.
...
- Output is structured as canvas nodes and edges written into a shared room.
...
- Users can view and download generated spec.
...
- Production object storage mnigration
...
4. AI can generate an architecture into a shared romm from a prompt
